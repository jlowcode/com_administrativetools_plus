...
JLoader::register('AdministrativetoolsHelper', JPATH_ADMINISTRATOR . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_administrativetools' . DIRECTORY_SEPARATOR . 'helpers' . DIRECTORY_SEPARATOR . 'administrativetools.php');
...
class AdministrativetoolsHelpersAdministrativetools
{
    ...
    public static function canUserEdit($item)
    {
        ...
        if ($user->authorise('core.edit', 'com_administrativetools'))
        {
            $permission = true;
        }
        else
        {
            ...
            {
                if ($user->authorise('core.edit.own', 'com_administrativetools') && $item->created_by == $user->id)
                {
                    $permission = true;
                }
            }

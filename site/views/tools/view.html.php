 ...
 * @since  1.6
 */
class AdministrativetoolsFEViewTools extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', Text::_('COM_ADMINISTRATIVETOOLS_DEFAULT_PAGE_TITLE'));
		}

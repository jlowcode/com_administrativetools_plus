...
class AdministrativetoolsViewTool extends \Joomla\CMS\MVC\View\HtmlView
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_ADMINISTRATIVETOOLS_TITLE_TOOL'), 'tool.png');

		// If not checked out, can save the item.
		if (!$checkedOut && ($canDo->get('core.edit') || ($canDo->get('core.create'))))
		{
			JToolBarHelper::apply('tool.apply', 'JTOOLBAR_APPLY');
			JToolBarHelper::save('tool.save', 'JTOOLBAR_SAVE');
		}

		if (!$checkedOut && ($canDo->get('core.create')))
		{
			JToolBarHelper::custom('tool.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
		}
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_administrativetools.tool', $this->item->id);
		}

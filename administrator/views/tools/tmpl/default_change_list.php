...
<form class="form-horizontal" id="formChangeList" name="formChangeList" method="post" enctype="multipart/form-data"
    ...
    <div class="control-group">
        <div class="controls">
            <label><strong><?php echo FText::_('COM_ADMINISTRATIVETOOLS_CHANGE_LIST_FIELD_LABEL0'); ?></strong></label>
        </div>
    </div>

    <div class="control-group">
        <label class="control-label" for="nameList"><?php echo FText::_('COM_ADMINISTRATIVETOOLS_LISTS'); ?></label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label" for="name"><?php echo FText::_('COM_ADMINISTRATIVETOOLS_CHANGE_LIST_NEW_NAME_FORM_LABEL'); ?></label>
        <div class="controls">
            <input form="formChangeList" type="text" class="form-control" id="name" name="name" required
                   placeholder="<?php echo FText::_('COM_ADMINISTRATIVETOOLS_CHANGE_LIST_NEW_NAME_FORM_LABEL'); ?>">
        </div>
    </div>
